<div class="modal fade" id="globalDiscountModal" tabindex="-1" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Diskon Global</h5>
            ...
            <div class="modal-body" x-data>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" x-model="globalDiskon.jumlah" placeholder="0">
                </div>
                <div class="text-end">
                    <span class="text-success fw-bold" x-text="formatRupiah(calculateGlobalDiscountValue())"></span>
                </div>
            </div>
